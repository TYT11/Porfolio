const lang = {
  en_us: {
    ...
    porfolioText:
      "Built with React. No CSS frameworks used. Utilize react-helmet & react-markdown.",
    marioniaText:
      "A full-stack store with auth, CRUD, shopping cart, and self-made carousel! Use Django Rest Framework as backend & Simple JWT to handle token auth.",
  ...
  zh_tw: {
    intro: "關於",
    introText:
      "我是依婷，前端自學約八個月，學習期間做了全端電商 Marionia 以及本個人網站。大學從事過英文家教、補教英文老師、文書翻譯等，雖非本科出身，但英文的助攻讓我能接觸相當多的資源。目前透過Udemy、edX等網站努力點技能中 :)",
    edu: "學歷",
    eduSchool: "國立臺灣科技大學",
    eduSchoolDeg: "　企業管理系",
    toolTitle: "工具箱",
